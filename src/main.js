...
// api.rosteryaghmiyan.ir
// 127.0.0.1:8000
axios.defaults.baseURL = "http://api.rosteryaghmiyan.ir/api/v1/admin";
window.baseImageAddress = "http://api.rosteryaghmiyan.ir/storage_public/";
